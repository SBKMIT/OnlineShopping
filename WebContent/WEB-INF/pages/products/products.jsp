...
<%@ page import="com.aits.onlineshoping.app.model.UserBean" %>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
	...
	<nav class="navbar navbar-default" role="navigation">
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><strong>Online</strong> Shop</a>
			</div>
			...
			<div class="collapse navbar-collapse"
				...
				<li><a href="showOrder">Show Order</a></li>
					
										
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown">${userBean.userName} <b class="caret"></b></a>
						<ul class="dropdown-menu">
							<li><a href="#"><strong>Call: </strong>${userBean.mobileNumber}</a></li>
							<li><a href="#"><strong>Mail: </strong>${userBean.emailId}</a></li>
							<li class="divider"></li>
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="row">
					...
					<div class="row">
						<c:forEach items="${productList}" var="product">
								...
								<img src="assets/ItemSlider/images/${product.pId}.jpg" alt="" />
								<div class="caption">
									<h3>
									...
									<p>
										<a href="order?productId=${product.pId}" class="btn btn-success" role="button">Add To
					...
					<!-- <div class="col-md-4 text-center col-sm-6 col-xs-6">
						<div class="thumbnail product-box">
							<img src="assets/ItemSlider/images/11.jpg" alt="" />
							<div class="caption">
								<h3>
									<a href="#">Puma </a>
								</h3>
					...
					<!-- <div class="col-md-4 text-center col-sm-6 col-xs-6">
						<div class="thumbnail product-box">
							<img src="assets/ItemSlider/images/10.jpg" alt="" />
							<div class="caption">
								<h3>
				...
				<!-- <div class="row">
					<div class="col-md-4 text-center col-sm-6 col-xs-6">
						<div class="thumbnail product-box">
							<img src="assets/ItemSlider/images/12.jpg" alt="" />
							<div class="caption">
								<h3>
									<a href="#">Traveler bag </a>
								</h3>
								<p>
					...
					<div class="col-md-4 text-center col-sm-6 col-xs-6">
						<div class="thumbnail product-box">
							<img src="assets/ItemSlider/images/13.jpg" alt="" />
							<div class="caption">
								<h3>
									<a href="#">Hand Bag </a>
								</h3>
								<p>
									Price : <strong>$45</strong>
								</p>
								<p>
									<a href="#">Ptional dismiss button </a>
								</p>
					...
					<div class="col-md-4 text-center col-sm-6 col-xs-6">
						<div class="thumbnail product-box">
							<img src="assets/ItemSlider/images/6.jpg" alt="" />
							<div class="caption">
								<h3>
									<a href="#">Caps</a>
								</h3>
								<p>
									Price : <strong>$ 30</strong>
								</p>
								<p>
									<a href="#">Ptional dismiss button </a>
								</p>
